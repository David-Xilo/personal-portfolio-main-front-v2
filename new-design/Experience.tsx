...
import type { ExperienceItem } from '../src/api/types.ts';
                                    ...
                                    <div className="flex flex-wrap items-center justify-between gap-4 mt-5 pt-4 border-t border-dm-line-soft dark:border-dm-line-soft-dark">
                                        <div className="flex flex-wrap gap-2">
                                            {item.tags.map((tag, tIdx) => (
                                                <span key={tIdx} className="font-mono text-[10.5px] tracking-wide px-2.5 py-[5px] bg-dm-bg-elev dark:bg-dm-bg-elev-dark/60 border border-dm-line dark:border-dm-line-dark rounded text-dm-text-mut dark:text-dm-text-mut-dark hover:border-dm-accent dark:hover:border-dm-accent-dark hover:text-dm-text dark:hover:text-dm-text-dark cursor-default transition-colors duration-200">
                                                    {tag}
                                                </span>
                                            ))}
                                        </div>
